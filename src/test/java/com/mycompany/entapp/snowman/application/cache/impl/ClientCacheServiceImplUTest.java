...
public class ClientCacheServiceImplUTest {
    ...
    @InjectMocks
    private ClientCacheServiceImpl systemUnderTest = new ClientCacheServiceImpl();

    @Test
    public void testClearCacheShouldRefreshCacheThroughPort() {
        systemUnderTest.clearCache();

        Mockito.verify(clientCachePort).refreshCache();
    }
}
