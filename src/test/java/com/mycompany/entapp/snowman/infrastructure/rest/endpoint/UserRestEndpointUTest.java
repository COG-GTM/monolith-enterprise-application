...
public class UserRestEndpointUTest {
    ...
    public void getUserWithUserIdShouldReturnTheUser() {
        ...
        try (MockedStatic<UserResourceMapper> mockedStatic = Mockito.mockStatic(UserResourceMapper.class)) {
            mockedStatic.when(() -> UserResourceMapper.mapUserToUserResource(user)).thenReturn(userResource);
    ...
    public void createUserShouldCreateUser(){
        ...
        try (MockedStatic<UserResourceMapper> mockedStatic = Mockito.mockStatic(UserResourceMapper.class)) {
            mockedStatic.when(() -> UserResourceMapper.mapUserResourceToUser(userResource)).thenReturn(user);
