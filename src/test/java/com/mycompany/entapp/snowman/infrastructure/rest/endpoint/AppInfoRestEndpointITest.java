...
public class AppInfoRestEndpointITest {
    ...
    @Test
    public void testGetApplicationInformation_ReturnsOkWithJson() throws Exception {
    ...
    @Test
    public void testGetApplicationInformation_WithDifferentVersion() throws Exception {
        AppInfo appInfo = new AppInfo();
        appInfo.setId(2);
        appInfo.setVersion("2.5.1");
        ...
        mockMvc.perform(get("/app/info"))
            ...
            .andExpect(jsonPath("$.version").value("2.5.1"));
    }

    @Test
    public void testGetApplicationInformation_VerifiesJsonContentType() throws Exception {
        AppInfo appInfo = new AppInfo();
        appInfo.setId(1);
        appInfo.setVersion("1.0.0");
    ...
    @Test
    public void testGetApplicationInformation_VerifiesJsonStructure() throws Exception {
        AppInfo appInfo = new AppInfo();
        appInfo.setId(1);
        appInfo.setVersion("1.0.0");
    ...
    @Test
    public void testGetApplicationInformation_PostMethodNotAllowed() throws Exception {
        mockMvc.perform(post("/app/info"))
            .andExpect(status().isMethodNotAllowed());
    }

    @Test(expected = org.springframework.web.util.NestedServletException.class)
    public void testGetApplicationInformation_ServiceThrowsException() throws Exception {
