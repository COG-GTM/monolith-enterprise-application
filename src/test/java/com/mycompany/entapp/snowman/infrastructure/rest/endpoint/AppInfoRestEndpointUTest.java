...
public class AppInfoRestEndpointUTest {
    ...
    public void testGetApplicationInformation() throws BusinessException {
        ...
        try (MockedStatic<AppInfoResourceMapper> mockedStatic = Mockito.mockStatic(AppInfoResourceMapper.class)) {
            mockedStatic.when(() -> AppInfoResourceMapper.mapAppInfoToResource(appInfo)).thenReturn(appInfoResource);
